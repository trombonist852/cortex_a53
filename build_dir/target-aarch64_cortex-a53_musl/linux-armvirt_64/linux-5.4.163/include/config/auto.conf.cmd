deps_config := \
	...
	drivers/clk/Kconfig \
	drivers/platform/mikrotik/Kconfig \
...
ifneq "$(KERNELVERSION)" "5.4.163"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "aarch64-openwrt-linux-musl-gcc (OpenWrt GCC 8.4.0 r19085-9a6b44849d) 8.4.0"
include/config/auto.conf: FORCE
endif
...
ifneq "$(OBJCOPY)" "aarch64-openwrt-linux-musl-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
